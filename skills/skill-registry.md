...
|---|---|---|---|---|---|
| `plan-to-spec` | Convert a plan into narrow task specs | A plan exists but execution still needs task boundaries | plan, current phase context | task specs, validation guidance, write-back guidance | active |
